...
public class CustomerTest extends TestCase {
    ...
    public void testStatement(){
        PersonDescription personDesc = new PersonDescription("Nikitha", "", "");
        Customer nikithaCustomer = new Customer(personDesc);
        ...
        String htmlStatement = nikithaCustomer.getStatement().htmlStatement();
